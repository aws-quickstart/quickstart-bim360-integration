...
const callbackUrlParam = process.env.FORGE_CALLBACK_URL_PARAM;
...
module.exports = {
    ...
    forgeAWSCallbackUrl: async function() {
        let parameter = await awsParamStore.getParameter( callbackUrlParam ,this.getParamStore());
        return parameter.Value;
    }
};
